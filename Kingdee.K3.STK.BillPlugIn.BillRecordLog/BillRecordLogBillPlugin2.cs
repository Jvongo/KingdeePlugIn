...
namespace Kingdee.K3.STK.BillPlugIn.BillRecordLog
{
    ...
    public class BillRecordLogBillPlugin2 : AbstractBillPlugIn
    {
        List<Dictionary<string, string>> colist = new List<Dictionary<string, string>>();

        Dictionary<string, string> oldvaluefoSubject = new Dictionary<string, string>();
        List<Dictionary<string, string>> oldvaluesfoItem = new List<Dictionary<string, string>>();
        string billstate;
